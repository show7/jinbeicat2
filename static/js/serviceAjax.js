exports.install = function(Vue, options) {
	Vue.prototype.queryAjax = function(rqpath, rqtype, param,accessToken) {
		var url = "https://apione.jinbeicat.com/ruqing-query/"+rqpath+"?accessToken="+accessToken;
		var result;
		 $.ajax(url,{					
			type:rqtype ,
			dataType: "json",
	...
	Vue.prototype.serviceAjax = function(rqpath, rqtype, param,accessToken) {
		var url = "https://apione.jinbeicat.com/ruqing-server/"+rqpath+"?accessToken="+accessToken;
		var result;
		$.ajax(url,{					
			type:rqtype ,
			dataType: "json",
	...
	Vue.prototype.queryAjax2 = function(rqpath, rqtype, param,accessToken) {
		var url = "https://www.jinbeicat.com/"+rqpath;
		var result;
		 $.ajax(url,{					
			type:rqtype ,
			dataType: "json",
	...
	Vue.prototype.queryAjax3 = function(rqpath, rqtype, param,accessToken) {
		var url = "https://www.jinbeicat.com/"+rqpath+"?accessToken="+accessToken;
		var result;
		 $.ajax(url,{					
			type:rqtype ,
			dataType: "json",
	...
	Vue.prototype.queryAjax4 = function(rqpath, rqtype, param,accessToken) {
		var url = "https://apione.jinbeicat.com/ruqing-integral/"+rqpath+"?accessToken="+accessToken;
		var result;
		 $.ajax(url,{					
			type:rqtype ,
			dataType: "json",
	...
	Vue.prototype.Const ='https://www.jinbeicat.com/'
	Vue.prototype.Const1 ='https://www.jinbeicat.com'
